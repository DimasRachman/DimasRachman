    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $r1['nama_mesin'] ?></td>
                <td><?php echo $r1['spesifikasi'] ?></td>
            </tr>
        <?php
        }
        ?>
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="informasi_mesin.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
