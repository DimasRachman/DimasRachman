    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><center>
                    <a href="luasLahan_input.php?id=<?php echo $r1['id']?>">
                        <span class="badge bg-warning text-dark">Edit</span>
                    </a>

                    <a href="luasLahan.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Hapus Data?')">
...
<nav aria-label="Page navigation example">
    <ul class="pagination">
        ...
        for($i=1; $i <= $pages; $i++){
            ?>
            <li class="page-item">
                <a class="page-link" href="luasLahan.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
            </li>
            <?php
        }
        ?>
